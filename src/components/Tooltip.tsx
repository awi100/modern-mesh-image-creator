...
export default function Tooltip({ label, children, position = "top", shortcut }: TooltipProps) {
  return (
    <div className="relative group/tip">
      {children}
      <div
        className={`absolute left-1/2 -translate-x-1/2 px-2 py-1 bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 text-xs rounded whitespace-nowrap opacity-0 group-hover/tip:opacity-100 pointer-events-none transition-opacity z-50 flex items-center gap-1.5 ${

      ...
      <header className="bg-slate-800 border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Modern Mesh</h1>
              <p className="text-sm text-slate-400">Image Creator</p>
            </div>
          </div>
        ...
        <main className="flex-1">
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-slate-400 mb-6">Create your first needlepoint design to get started.</p>
              <Link
                href="/design/new"

...
export default function AnalyticsPage() {
  ...
  const { data: analytics, isLoading, error, mutate } = useSWR<OrderAnalytics>("/api/analytics/orders", {
      ...
      <header className="bg-slate-800 border-b border-slate-700 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-slate-400 text-sm">Last {analytics.summary.periodDays} days</span>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-slate-800 rounded-xl border border-slate-700 p-4">
                ...
                <p className="text-xs text-slate-500">{analytics.summary.avgUnitsPerOrder} per order</p>
              </div>
              <div className="bg-slate-800 rounded-xl border border-slate-700 p-4">
                ...
                <p className="text-xs text-slate-500">{analytics.summary.totalKitUnits} kits sold</p>
              </div>
              <div className="bg-slate-800 rounded-xl border border-slate-700 p-4">
            ...
            {/* Weekly Trend */}
            <div className="bg-slate-800 rounded-xl border border-slate-700 p-4">
              <h3 className="text-white font-semibold mb-4">Weekly Sales Trend</h3>
        ...
        {activeTab === "designs" && (
          <div className="bg-slate-800 rounded-xl border border-slate-700 overflow-hidden">
            <div className="p-4 border-b border-slate-700">
              ...
              <p className="text-sm text-slate-400">Sales and kit attachment by design</p>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-700 text-left">
                    ...
                    <th className="p-3 text-xs text-slate-400 font-medium text-right">Units Sold</th>
                    <th className="p-3 text-xs text-slate-400 font-medium text-right">Kits Sold</th>
                    <th className="p-3 text-xs text-slate-400 font-medium text-right">Kit Rate</th>
                    <th className="p-3 text-xs text-slate-400 font-medium text-right">In Stock</th>
                    <th className="p-3 text-xs text-slate-400 font-medium">Velocity</th>
                  </tr>
                </thead>
                <tbody>
                  {analytics.designPerformance.map((design) => (

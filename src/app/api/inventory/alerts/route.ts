...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const excludedDesigns = await prisma.design.findMany({
      where: { isDraft: false, deletedAt: null, archivedAt: null, notLiveAt: null, excludeFromStockAlerts: true, printVersionOf: null, ...meshWhere },
    ...
    const designs = await prisma.design.findMany({
      where: { isDraft: false, deletedAt: null, archivedAt: null, notLiveAt: null, excludeFromStockAlerts: false, printVersionOf: null, ...meshWhere },
      select: {
        id: true,
        name: true,
